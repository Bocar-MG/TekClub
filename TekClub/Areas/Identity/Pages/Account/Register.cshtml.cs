...
namespace TekClub.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DisplayName("Envoyez une demande pour creer votre club ?")]
            public bool CreateClub { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.CreateClub)
                {
                    user.Status = "Souhaite créer un club";
                }
                user.Nom = Input.Nom;
